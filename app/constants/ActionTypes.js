export const FETCH_ARTICLE_LIST = 'FETCH_ARTICLE_LIST'; //发出请求；

export const RECEIVE_ARTICLE_LIST = 'RECEIVE_ARTICLE_LIST'; //接受阅读请求；
...
export const FETCH_BEAUTY_LIST = 'FETCH_BEAUTY_LIST';